...
"use strict";
/*!*******************************!*\
  !*** ./public/js/noteEdit.js ***!
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   EditableNote: () => (/* binding */ EditableNote),
/* harmony export */   EditableSplit: () => (/* binding */ EditableSplit)
/* harmony export */ });
/* harmony import */ var _noteStatic_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./noteStatic.js */ "./public/js/noteStatic.js");
/* harmony import */ var _note_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./note.js */ "./public/js/note.js");
...
window.addEventListener('load', () => {
    ...
    if (resizeHandle) {
        resizeHandle.addEventListener('mousedown', (ev) => {
            ...
            console.log(note);
            if (!(note instanceof _note_js__WEBPACK_IMPORTED_MODULE_1__.Note))
                return;
...
class EditableNote extends _note_js__WEBPACK_IMPORTED_MODULE_1__.Note {
            ...
            fetch(`${baseURL}/room/${window.state.roomId}/note/`, {
                ...
                if (json.msg)
                    ...
                    if (lastHighlight) {
                        ...
                        (0,_noteStatic_js__WEBPACK_IMPORTED_MODULE_0__.updateHighlights)(this.parent);
                        this.parent.save();
                    }
...
class EditableSplit extends _noteStatic_js__WEBPACK_IMPORTED_MODULE_0__.Split {
    onHover() {
        super.onHover();
        if (window.state.dragging || window.state.resizing)
            return;
